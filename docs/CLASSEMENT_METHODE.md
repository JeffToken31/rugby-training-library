...
91 fiches examinées : 80 candidates individuelles, 9 descriptions insuffisantes et 2 fiches composites ou à périmètre de source ambigu. Les candidates ne sont pas certifiées uniques. Trois paires possiblement équivalentes, un chevauchement possible, deux autres cas incertains/composites et cinq différences documentées. Aucun retrait ni fusion. Les sources manquantes restent à relire ; le nombre unique exact reste indéterminé.
